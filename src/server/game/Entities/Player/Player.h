...
class TC_GAME_API Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        void CastItemCombatSpell(Unit* target, CalcDamageInfo const& damageInfo);
        void CastItemCombatSpell(Unit* target, DamageInfo const& damageInfo, Item* item, ItemTemplate const* proto);
