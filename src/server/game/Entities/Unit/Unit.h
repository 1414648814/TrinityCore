...
class TC_GAME_API Unit : public WorldObject
{
    public:
        ...
        void ProcDamageAndSpell(Unit* victim, uint32 procAttacker, uint32 procVictim, uint32 hitMask, uint32 amount, WeaponAttackType attType = BASE_ATTACK, SpellInfo const* procSpell = NULL, SpellInfo const* procAura = NULL);
        void ProcDamageAndSpellFor(bool isVictim, Unit* target, uint32 procFlag, uint32 hitMask , WeaponAttackType attType, SpellInfo const* procSpell, uint32 damage, SpellInfo const* procAura = NULL);
